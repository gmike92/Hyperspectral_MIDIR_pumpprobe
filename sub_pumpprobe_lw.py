...
class PumpProbeScanWindow(QtWidgets.QWidget):
    ...
    def start_scan(self):
        ...
        try:
            ...
            self.status_label.setText(f"Status: CSV init failed — {e}")
        ...
        try:
            ...
            if odd_data is not None and even_data is not None:
                ...
                try:
                    ...
                    self.status_label.setText(f"Status: CSV write failed — {e}")
                    print(f"[ERROR] CSV append failed: {e}")
    ...
    def _scan_complete(self):
        ...
        if self.scan_delays:
            ...
            try:
                ...
                self.status_label.setText(f"Status: Final save failed — {e}")
                print(f"[ERROR] Final NPZ save failed: {e}")
        else:
